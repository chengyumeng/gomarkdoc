...
```go
import "github.com/chengyumeng/gomarkdoc/testData/docs"
```
...
<a name="Func"></a>
## func [Func](<https://github.com/chengyumeng/gomarkdoc/blob/master/testData/docs/docs.go#L64>)
...
## type [AnotherStruct](<https://github.com/chengyumeng/gomarkdoc/blob/master/testData/docs/anotherFile.go#L5-L7>)
...
### func [NewAnotherStruct](<https://github.com/chengyumeng/gomarkdoc/blob/master/testData/docs/anotherFile.go#L10>)
...
### func \(\*AnotherStruct\) [GetField](<https://github.com/chengyumeng/gomarkdoc/blob/master/testData/docs/anotherFile.go#L17>)
...
<a name="Type"></a>
## type [Type](<https://github.com/chengyumeng/gomarkdoc/blob/master/testData/docs/docs.go#L69>)
...
<a name="Type.Func"></a>
### func \(\*Type\) [Func](<https://github.com/chengyumeng/gomarkdoc/blob/master/testData/docs/docs.go#L72>)
